...
const IonTabBarContainer = React.memo((_a) => {
    ...
    return (React.createElement(IonTabBarUnwrapped, Object.assign({ ref: forwardedRef }, props, { currentPath: props.currentPath || context.currentPath }), props.children));
});
...
class IonTabs extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(IonTabsContext.Provider, { value: this.ionTabContextState },
            React.createElement("div", { style: hostStyles },
