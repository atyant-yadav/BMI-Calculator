...
const IonTabBarContainer = React__default.memo((_a) => {
    ...
    return (React__default.createElement(IonTabBarUnwrapped, Object.assign({ ref: forwardedRef }, props, { currentPath: props.currentPath || context.currentPath }), props.children));
});
...
class IonTabs extends React__default.Component {
    ...
    render() {
        ...
        return (React__default.createElement(IonTabsContext.Provider, { value: this.ionTabContextState },
            React__default.createElement("div", { style: hostStyles },
